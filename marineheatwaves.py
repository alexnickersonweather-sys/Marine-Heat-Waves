# Purpose: A set of functions which implement the Marine Heat Wave (MHW)
#          definition of Hobday et al. (2016)
#
# Date of Version 01: 2020
# Date of Version 02: Jan. 20, 2026
#
# Author 01: Eric C.J. Oliver
# Author 02: Alexander Nickerson
#
# Version 02 merely brings the code up to 2026 Python standards
#
...
def detect(t, temp, climatologyPeriod=[None,None], pctile=90, windowHalfWidth=5, smoothPercentile=True, smoothPercentileWidth=31, minDuration=5, joinAcrossGaps=True, maxGap=2, maxPadLength=False, coldSpells=False, alternateClimatology=False, Ly=False):
    ...
    #      optional maxPadLength) will be set equal to the seasonal climatology. This means they will
